...
{
    cout << "4:  " << solveNQueen(4) << endl;
    cout << "5:  " << solveNQueen(5) << endl;
    cout << "6:  " << solveNQueen(6) << endl;
    cout << "7:  " << solveNQueen(7) << endl;
    cout << "8:  " << solveNQueen(8) << endl;
    cout << "9:  " << solveNQueen(9) << endl;
    return 0;
}
